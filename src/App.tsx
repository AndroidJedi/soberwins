        ...
        <div className="absolute top-8 inset-x-0 z-30">
          <div className="max-w-[1440px] mx-auto px-6 lg:px-12 flex items-center justify-between">
            ...
            <div className="inline-flex items-center gap-3">
              {isAuthed ? (
                <>
                  <button onClick={handleShare} className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl border border-white/15 text-white/80 bg-white/5 hover:bg-white/10 backdrop-blur-md transition shadow-md touch-manipulation">
